...
if __name__ == "__main__":
    ...
    parser.add_argument('--k_retrieval', type=int, default=150)
    parser.add_argument('--k_retrieval', type=int, default=30)
    parser.add_argument('--claim_retrieved_file', type=str)
    parser.add_argument('--scifact_abstract_retrieval_file', type=str, help="abstract retreival in scifact format",
                        default='../data/claims_dev_retrieved_BioSV.jsonl')
    parser.add_argument('--corpus_embedding_pickle', type=str, default="corpus_paragraph_biosentvec.pkl")
    parser.add_argument('--claim_embedding_pickle', type=str, default="claim_biosentvec.pkl")
